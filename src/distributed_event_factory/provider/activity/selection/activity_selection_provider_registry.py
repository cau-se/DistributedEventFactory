from distributed_event_factory.provider.activity.generation.activity_generation_registry import \
...
from distributed_event_factory.provider.activity.selection.ordered.ordered_selection_provider import \
    OrderedActivitySelectionProviderFactory
from distributed_event_factory.provider.activity.selection.single.single_selection_provider import \
    SingleActivitySelectionProviderFactory
from distributed_event_factory.provider.activity.selection.uniform.uniform_selection_provider import \
